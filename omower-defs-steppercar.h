// PINs and other stuff definitions for test stepper car
// with DRV8825 and stepper motors on wheels
...
// stepper motors on wheels and two DRV8825
#define MOT_DRIVER_DRV8825

// Number of cycles to wake up DRV8825
#define DRV8825_WAKEUP 100

#define PIN_MOT_LEFTFORW_FAULT 46
#define PIN_MOT_RIGHTFORW_FAULT 52
#define PIN_MOT_FORW_ENABLE 10
#define PIN_MOT_LEFTFORW_DIR 44
#define PIN_MOT_RIGHTFORW_DIR 45
#define PIN_MOT_LEFTFORW_STEP 34
#define PIN_MOT_RIGHTFORW_STEP 36
